...
import 'package:flutter_codebase/core/wrappers/responsive_input_field.dart';
...
/// A common dropdown/text/date input wrapper.
            ...
            builder: (context, selectedValue, _) {
              return DropdownButtonFormField<String>(
                ...
                decoration: InputDecoration(
                  ...
                  filled: true,
                  fillColor: fillColor ?? const Color(0xFFF6F8FA),
                ),
                icon: const Icon(
  ...
  OutlineInputBorder _buildOutlineInputBorder() {
    return OutlineInputBorder(
      ...
      borderSide: BorderSide(
        color: const Color(0xFFB3A28A),
        width: ScreenSize.setWidth(1),
      ),
    );
  }
}
